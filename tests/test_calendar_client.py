...
def test_make_event_objects_and_dry_run():
    schedule = [
        {"task_id": 1, "start_ts": "2025-01-01T09:00:00Z", "end_ts": "2025-01-01T10:00:00Z", "title": "Meet"}
    ]
...
def test_apply_create_events_dry_run():
    ...
    assert isinstance(res, list) and res[0]["reason"] == "dry_run" or res[0].get("success") is False
