...
def test_basic_schedule_respects_buffer():
    ...
    sched = create_schedule(tasks, {"hours_per_day": 4, "start_date": "2025-01-01"}, buffer_ratio=0.25)
...
def test_zero_capacity_raises():
    ...
    with pytest.raises(ValueError):
        create_schedule(tasks, {"hours_per_day": 1, "start_date": "2025-01-01"}, buffer_ratio=1.0)
...
def test_exact_fit_and_many_small_tasks():
    ...
    sched = create_schedule(tasks, {"hours_per_day": 2, "start_date": "2025-01-01"}, block_min=10, buffer_ratio=0.0)
